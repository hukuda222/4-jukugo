...
model = LanguageModelingTransformer(
    pretrained_model_name_or_path="rinna/japanese-gpt2-small", tokenizer=tokenizer
)
model = model.load_from_checkpoint(
    "lightning_logs/version_0/checkpoints/epoch=9-step=1170.ckpt", device_map="auto"
).to(torch.device("cpu"))
