...
class Sumitomo2Spider(scrapy.Spider):
    ...
    def parse(self, response):
        titles = response.xpath('//*[@id="main_article"]/div/div[2]/div/div/section/div/div/div/p/img/@alt').extract()
        meanings = response.xpath('//*[@id="main_article"]/div/div[2]/div/div/section/div/div/div/div/div/p/text()').extract()
        print(titles)
