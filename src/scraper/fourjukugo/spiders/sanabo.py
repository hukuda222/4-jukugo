...
class SanaboSpider(scrapy.Spider):
    ...
    def parse(self, response):
        urls = response.xpath('//*[@id="custom_html-15"]/div/center/table/tr/td/a/@href').extract()
        #print("1",urls)
    ...
    def parse_4char(self,response):
        ...
        meaning = response.xpath('/html/body/div[1]/div[3]/div/main/article/section/ul//text()').extract()[1:2]
        source = response.xpath('/html/body/div[1]/div[3]/div/main/article/section/div[2]/ul/li[1]/text()').extract()
